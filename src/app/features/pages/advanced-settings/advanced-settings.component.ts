...
export class AdvancedSettingsComponent implements OnInit {
  ...
  protected readonly advancedSettings = toSignal(
    this.route.data.pipe(
      map(({ advancedSettings }) => advancedSettings as AdvancedSettingsResponse),
    ),
    { initialValue: null },
  );
  ...
  readonly tabs: NabVarItem[] = [
    ...
    {
      id: 2,
      selectorId: 'advanced-settings-security-tab',
      label: 'Security',
      icon: '@tui.shield',
      enabled: true,
    },
    {
      id: 3,
      selectorId: 'advanced-settings-users-tab',
      label: 'Users',
      icon: '@tui.user',
      enabled: false,
      hint: 'Comming Soon',
    ...
    {
      id: 4,
      selectorId: 'advanced-settings-dashboard-tab',
      label: 'Dashboard',
  ...
  currentInputs = computed(() => {
    switch (this.index()) {
      case 0:
        return { data: this.advancedSettings()?.generalSettings };
      case 1:
        return { data: this.advancedSettings()?.accessPointSettings };
      case 2:
        return { data: this.advancedSettings()?.applicationSecurity };
      case 3:
        return { data: this.advancedSettings()?.generalSettings };
      case 4:
        return { data: this.advancedSettings()?.generalSettings };
  ...
  currentBreadcrumb() {
    ...
    switch (this.index()) {
      case 0:
        newBreadcrumb = 'General';
        break;
      case 1:
        newBreadcrumb = 'Access Point Settings';
        break;
      case 2:
        newBreadcrumb = 'Application Security';
        break;
      case 3:
        newBreadcrumb = 'Users Management';
        break;
      case 4:
        newBreadcrumb = 'Dashboard Settings';
        break;
      default:
        newBreadcrumb = 'Not Indexed';
    }
