...
export const routes: Routes = [
  {
    path: '',
    loadComponent: () =>
      import('./features/pages/site-layout/site-layout.component').then(
    ...
    children: [
      {
        path: 'chart',
        loadComponent: () =>
          import('./features/pages/temperature-chart/temperature-chart.component').then(
      ...
      },
      {
        path: 'list',
        loadComponent: () =>
          import('./features/pages/sensor-list/sensor-list.component').then(
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/pages/sensor-detail/sensor-detail.component').then(
      ...
      },
      {
        path: 'settings',
        loadComponent: () =>
          import('./features/pages/settings/settings.component').then((m) => m.SettingsComponent),
        resolve: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/pages/advanced-settings/advanced-settings.component').then(
